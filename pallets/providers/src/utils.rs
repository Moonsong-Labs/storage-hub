    ...
    T: pallet::Config,
{
    ...
    pub fn do_bsp_sign_up(
        ...
        // TODO:
        // We then get the BackupStorageProviderId by using the AccountId as the seed for a random generator
        // let (msp_id, block_number_when_random) =
        //    T::ProvidersRandomness::random(who.encode().as_ref());

        // Temporary, replace with random salt generated by a VRF
