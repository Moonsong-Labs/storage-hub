...
parameter_types! {
    ...
    pub const BucketCreationDeposit: Balance = 10;
    pub const FileSystemHoldReason: RuntimeHoldReason = RuntimeHoldReason::FileSystem(pallet_file_system::HoldReason::BucketCreationDeposit);
}
...
impl crate::Config for Test {
    ...
    type BucketCreationDeposit = BucketCreationDeposit;
}
