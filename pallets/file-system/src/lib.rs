...
pub mod pallet {
    ...
    pub trait Config: frame_system::Config {
        ...
        /// Deposit held from the User when creating a new bucket with a MSP
        #[pallet::constant]
        type BucketCreationDeposit: Get<BalanceOf<Self>>;
    }
    ...
    pub enum HoldReason {
        /// Deposit that a user has to pay to create a bucket with a MSP
        BucketCreationDeposit,
