...
//!
//! THIS FILE WAS AUTO-GENERATED USING THE `generateBenchmarkProofs.ts` SCRIPT FROM STORAGE HUB.
//! DATE: {{date}}.
//!
...
//! 3. Run the script with `pnpm docker:start:generateBenchmarkProofs`.
//!
