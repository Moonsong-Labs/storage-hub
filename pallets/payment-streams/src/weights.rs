...
pub trait WeightInfo {
	...
	fn n_providers_last_chargeable_info_update(n: u32, ) -> Weight;
	fn n_providers_last_chargeable_info_update_not_enough_weight(n: u32, ) -> Weight;
	fn n_providers_last_chargeable_info_update_for_already_processed_tick(n: u32, ) -> Weight;
	fn n_providers_last_chargeable_info_update_for_already_processed_tick_not_enough_weight(n: u32, ) -> Weight;
}
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn update_fixed_rate_payment_stream() -> Weight {
		...
		Weight::from_parts(242_000_000, 11034)
	...
	fn delete_fixed_rate_payment_stream() -> Weight {
		...
		Weight::from_parts(172_000_000, 11034)
	...
	fn create_dynamic_rate_payment_stream() -> Weight {
		...
		Weight::from_parts(64_000_000, 4148)
	...
	fn update_dynamic_rate_payment_stream() -> Weight {
		...
		Weight::from_parts(234_000_000, 11034)
			.saturating_add(T::DbWeight::get().reads(18_u64))
			.saturating_add(T::DbWeight::get().writes(6_u64))
	}
	/// Storage: `Providers::BackupStorageProviders` (r:1 w:0)
	...
	fn delete_dynamic_rate_payment_stream() -> Weight {
		...
		Weight::from_parts(236_000_000, 11034)
			.saturating_add(T::DbWeight::get().reads(18_u64))
	...
	fn charge_payment_streams() -> Weight {
		...
		Weight::from_parts(203_000_000, 11034)
			.saturating_add(T::DbWeight::get().reads(17_u64))
	...
	fn charge_multiple_users_payment_streams() -> Weight {
		...
		//  Measured:  `4321`
		//  Estimated: `32226`
		// Minimum execution time: 1_729_000_000 picoseconds.
		Weight::from_parts(1_748_000_000, 32226)
	...
	fn pay_outstanding_debt(n: u32, ) -> Weight {
		...
		Weight::from_parts(162_000_000, 11034)
			// Standard Error: 85_032
			.saturating_add(Weight::from_parts(88_225_815, 0).saturating_mul(n.into()))
	...
	/// Proof: `PaymentStreams::LastSubmittersTickRegistered` (`max_values`: Some(1), `max_size`: Some(37), added: 532, mode: `MaxEncodedLen`)
	...
	fn n_providers_last_chargeable_info_update(n: u32, ) -> Weight {
		...
		Weight::from_parts(24_371_959, 35487)
			// Standard Error: 8_920
			.saturating_add(Weight::from_parts(4_240_346, 0).saturating_mul(n.into()))
	...
	/// Storage: `PaymentStreams::AccumulatedPriceIndex` (r:1 w:0)
	/// Proof: `PaymentStreams::AccumulatedPriceIndex` (`max_values`: Some(1), `max_size`: Some(16), added: 511, mode: `MaxEncodedLen`)
	/// Storage: `PaymentStreams::LastChargeableInfo` (r:67 w:67)
	/// Proof: `PaymentStreams::LastChargeableInfo` (`max_values`: None, `max_size`: Some(68), added: 2543, mode: `MaxEncodedLen`)
	/// The range of component `n` is `[0, 1000]`.
	fn n_providers_last_chargeable_info_update_not_enough_weight(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `241 + n * (32 ±0)`
		//  Estimated: `35487 + n * (170 ±0)`
		// Minimum execution time: 10_000_000 picoseconds.
		Weight::from_parts(15_031_548, 35487)
			// Standard Error: 1_171
			.saturating_add(Weight::from_parts(332_788, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
			.saturating_add(Weight::from_parts(0, 170).saturating_mul(n.into()))
	}
	/// Storage: `PaymentStreams::LastSubmittersTickRegistered` (r:1 w:1)
	/// Proof: `PaymentStreams::LastSubmittersTickRegistered` (`max_values`: Some(1), `max_size`: Some(37), added: 532, mode: `MaxEncodedLen`)
	/// Storage: `ProofsDealer::ValidProofSubmittersLastTicks` (r:1 w:0)
	...
	/// Storage: `PaymentStreams::AccumulatedPriceIndex` (r:1 w:0)
	/// Proof: `PaymentStreams::AccumulatedPriceIndex` (`max_values`: Some(1), `max_size`: Some(16), added: 511, mode: `MaxEncodedLen`)
	/// Storage: `PaymentStreams::LastChargeableInfo` (r:999 w:999)
	/// Proof: `PaymentStreams::LastChargeableInfo` (`max_values`: None, `max_size`: Some(68), added: 2543, mode: `MaxEncodedLen`)
	/// Storage: `ProofsDealer::ChallengesTicker` (r:1 w:0)
	/// Proof: `ProofsDealer::ChallengesTicker` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	/// The range of component `n` is `[0, 1000]`.
	fn n_providers_last_chargeable_info_update_for_already_processed_tick(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `276 + n * (32 ±0)`
		//  Estimated: `49307 + n * (2467 ±1)`
		// Minimum execution time: 8_000_000 picoseconds.
		Weight::from_parts(14_253_821, 49307)
			// Standard Error: 8_866
			.saturating_add(Weight::from_parts(4_291_428, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
			.saturating_add(Weight::from_parts(0, 2467).saturating_mul(n.into()))
	}
	/// Storage: `PaymentStreams::LastSubmittersTickRegistered` (r:1 w:1)
	/// Proof: `PaymentStreams::LastSubmittersTickRegistered` (`max_values`: Some(1), `max_size`: Some(37), added: 532, mode: `MaxEncodedLen`)
	/// Storage: `ProofsDealer::ValidProofSubmittersLastTicks` (r:1 w:0)
	...
	/// Storage: `PaymentStreams::AccumulatedPriceIndex` (r:1 w:0)
	/// Proof: `PaymentStreams::AccumulatedPriceIndex` (`max_values`: Some(1), `max_size`: Some(16), added: 511, mode: `MaxEncodedLen`)
	/// Storage: `PaymentStreams::LastChargeableInfo` (r:48 w:48)
	/// Proof: `PaymentStreams::LastChargeableInfo` (`max_values`: None, `max_size`: Some(68), added: 2543, mode: `MaxEncodedLen`)
	/// Storage: `ProofsDealer::ChallengesTicker` (r:1 w:0)
	/// Proof: `ProofsDealer::ChallengesTicker` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	/// The range of component `n` is `[0, 1000]`.
	fn n_providers_last_chargeable_info_update_for_already_processed_tick_not_enough_weight(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `276 + n * (32 ±0)`
		//  Estimated: `35487 + n * (121 ±0)`
		// Minimum execution time: 8_000_000 picoseconds.
		Weight::from_parts(21_583_256, 35487)
			// Standard Error: 916
			.saturating_add(Weight::from_parts(239_615, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
			.saturating_add(Weight::from_parts(0, 121).saturating_mul(n.into()))
	}
}
