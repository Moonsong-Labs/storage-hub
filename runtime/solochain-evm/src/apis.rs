...
use super::{
    AccountId, Balance, Block, Executive, Nonce, Runtime, RuntimeCall, RuntimeGenesisConfig,
    SessionKeys, System, TransactionPayment, TxExtension, UncheckedExtrinsic, VERSION,
};
...
impl_runtime_apis! {
    ...
    impl pallet_storage_providers_runtime_api::StorageProvidersApi<Block, BlockNumber, BackupStorageProviderId<Runtime>, BackupStorageProvider<Runtime>, MainStorageProviderId<Runtime>, AccountId, ProviderIdFor<Runtime>, StorageProviderId<Runtime>, StorageDataUnit<Runtime>, Balance, BucketId<Runtime>, Multiaddresses<Runtime>, ValuePropositionWithId<Runtime>, H256> for Runtime {
        ...
        fn log_message() -> bool {
            log::info!(
                ...
                "StorageProvidersApi::log_message called from the solochain EVM runtime."
            );
    ...
    impl shp_tx_implicits_runtime_api::TxImplicitsApi<Block> for Runtime {
        fn compute_signed_extra_implicit(
            ...
            let extra: TxExtension = cumulus_pallet_weight_reclaim::StorageWeightReclaim::<
                Runtime,
                _,
            >::new((
            ...
            let implicit = <TxExtension as sp_runtime::traits::TransactionExtension<RuntimeCall>>::implicit(&extra)?;
            Ok(implicit.encode())
        }
    }
