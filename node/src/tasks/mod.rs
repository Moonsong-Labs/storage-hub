...
impl<T, FL, FS> EventHandler<NewStorageRequest>
    for NewStorageRequestHandler<T, FL, FS>
    where
        T: TrieLayout,
        FL: Send + Sync + FileStorage<T>,
        FS: Send + Sync + ForestStorage<T>,
...
impl<T, FL, FS> EventHandler<AcceptedBspVolunteer>
    for AcceptedBspVolunteerHandler<T, FL, FS>
    where
        T: TrieLayout,
        FL: Send + Sync + FileStorage<T>,
        FS: Send + Sync + ForestStorage<T>,
