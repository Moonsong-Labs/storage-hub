...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        ...
        fileSystem: {
             ...
             **/
            BspFileDeletionCompleted: AugmentedEvent<ApiType, [user: AccountId20, fileKey: H256, fileSize: u64, bspId: H256, oldRoot: H256, newRoot: H256], {
                user: AccountId20;
                fileKey: H256;
                fileSize: u64;
                bspId: H256;
             ...
             **/
            FailedToDecreaseMspUsedCapacity: AugmentedEvent<ApiType, [user: AccountId20, mspId: H256, fileKey: H256, fileSize: u64, error: SpRuntimeDispatchError], {
                user: AccountId20;
                mspId: H256;
                fileKey: H256;
                fileSize: u64;
             ...
             **/
            FailedToGetMspOfBucket: AugmentedEvent<ApiType, [bucketId: H256, error: SpRuntimeDispatchError], {
                bucketId: H256;
                error: SpRuntimeDispatchError;
            }>;
            /**
             ...
             **/
            FailedToQueuePriorityChallenge: AugmentedEvent<ApiType, [fileKey: H256, error: SpRuntimeDispatchError], {
                fileKey: H256;
                error: SpRuntimeDispatchError;
            }>;
            /**
             ...
             **/
            FailedToTransferDepositFundsToBsp: AugmentedEvent<ApiType, [fileKey: H256, owner: AccountId20, bspId: H256, amountToTransfer: u128, error: SpRuntimeDispatchError], {
                fileKey: H256;
                owner: AccountId20;
                bspId: H256;
             ...
             **/
            FileDeletedFromIncompleteStorageRequest: AugmentedEvent<ApiType, [fileKey: H256, providerId: H256], {
                fileKey: H256;
                providerId: H256;
            }>;
            /**
             ...
             **/
            FileDeletionRequest: AugmentedEvent<ApiType, [user: AccountId20, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool], {
                user: AccountId20;
                fileKey: H256;
                fileSize: u64;
                bucketId: H256;
             ...
             **/
            MspFileDeletionCompleted: AugmentedEvent<ApiType, [user: AccountId20, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, oldRoot: H256, newRoot: H256], {
                user: AccountId20;
                fileKey: H256;
                fileSize: u64;
                bucketId: H256;
             ...
             **/
            PriorityChallengeForFileDeletionQueued: AugmentedEvent<ApiType, [issuer: PalletFileSystemEitherAccountIdOrMspId, fileKey: H256], {
             ...
             **/
            ProofSubmittedForPendingFileDeletionRequest: AugmentedEvent<ApiType, [user: AccountId20, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool], {
                user: AccountId20;
                fileKey: H256;
                fileSize: u64;
                bucketId: H256;
