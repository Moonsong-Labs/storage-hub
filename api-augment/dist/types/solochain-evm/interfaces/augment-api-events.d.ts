...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        ...
        fileSystem: {
             ...
             **/
            NewStorageRequestV2: AugmentedEvent<ApiType, [who: AccountId20, fileKey: H256, bucketId: H256, location: Bytes, fingerprint: H256, size_: u64, peerIds: Vec<Bytes>, expiresAt: u32, bspsRequired: u32, mspId: Option<H256>], {
                who: AccountId20;
                fileKey: H256;
                bucketId: H256;
                location: Bytes;
             ...
             **/
            UserOperationPauseFlagsUpdated: AugmentedEvent<ApiType, [old: u32, new_: u32], {
                old: u32;
                new_: u32;
            }>;
            /**
