...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        ...
        fileSystem: {
             ...
             **/
            FailedToDecreaseMspUsedCapacity: AugmentedEvent<ApiType, [user: AccountId32, mspId: H256, fileKey: H256, fileSize: u64, error: SpRuntimeDispatchError], {
                user: AccountId32;
                mspId: H256;
                fileKey: H256;
                fileSize: u64;
             ...
             **/
            FailedToTransferDepositFundsToBsp: AugmentedEvent<ApiType, [fileKey: H256, owner: AccountId32, bspId: H256, amountToTransfer: u128, error: SpRuntimeDispatchError], {
                fileKey: H256;
                owner: AccountId32;
                bspId: H256;
             ...
             **/
            FileDeletionRequest: AugmentedEvent<ApiType, [user: AccountId32, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool], {
                user: AccountId32;
                fileKey: H256;
                fileSize: u64;
                bucketId: H256;
             ...
             **/
            MspFileDeletionCompleted: AugmentedEvent<ApiType, [user: AccountId32, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, oldRoot: H256, newRoot: H256], {
                user: AccountId32;
                fileKey: H256;
                fileSize: u64;
                bucketId: H256;
             ...
             **/
            ProofSubmittedForPendingFileDeletionRequest: AugmentedEvent<ApiType, [user: AccountId32, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool], {
                user: AccountId32;
                fileKey: H256;
                fileSize: u64;
                bucketId: H256;
