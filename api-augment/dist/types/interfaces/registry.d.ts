...
import type {
  ...
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigDecayRate,
  ...
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigLowerExponentFactor,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxPrice,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxReplicationTarget,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMaximumTreasuryCut,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinChallengePeriod,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinPrice,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinSeedPeriod,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinWaitForStopStoring,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinimumTreasuryCut,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMostlyStablePrice,
  ...
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigProviderTopUpTtl,
  ...
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStakeToSeedPeriod,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStandardReplicationTarget,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStorageRequestTtl,
  ...
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigUpfrontTicksToPay,
  ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigUpperExponentFactor,
...
declare module "@polkadot/types/types/registry" {
  interface InterfaceTypes {
    ...
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigBasicReplicationTarget: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigBasicReplicationTarget;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigBspStopStoringFilePenalty: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigBspStopStoringFilePenalty;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigCheckpointChallengePeriod: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigCheckpointChallengePeriod;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigDecayRate: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigDecayRate;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigHighSecurityReplicationTarget: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigHighSecurityReplicationTarget;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigIdealUtilisationRate: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigIdealUtilisationRate;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigLowerExponentFactor: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigLowerExponentFactor;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxPrice: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxPrice;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxReplicationTarget: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxReplicationTarget;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMaximumTreasuryCut: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMaximumTreasuryCut;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinChallengePeriod: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinChallengePeriod;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinPrice: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinPrice;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinSeedPeriod: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinSeedPeriod;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinWaitForStopStoring: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinWaitForStopStoring;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinimumTreasuryCut: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMinimumTreasuryCut;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMostlyStablePrice: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigMostlyStablePrice;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigParameters: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigParameters;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigParametersKey: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigParametersKey;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigParametersValue: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigParametersValue;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigProviderTopUpTtl: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigProviderTopUpTtl;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigSlashAmountPerMaxFileSize: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigSlashAmountPerMaxFileSize;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStakeToChallengePeriod: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStakeToChallengePeriod;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStakeToSeedPeriod: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStakeToSeedPeriod;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStandardReplicationTarget: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStandardReplicationTarget;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStorageRequestTtl: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigStorageRequestTtl;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigSuperHighSecurityReplicationTarget: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigSuperHighSecurityReplicationTarget;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationLowerThresholdPercentage: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationLowerThresholdPercentage;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationUpperThresholdPercentage: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationUpperThresholdPercentage;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigTickRangeToMaximumThreshold: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigTickRangeToMaximumThreshold;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigUltraHighSecurityReplicationTarget: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigUltraHighSecurityReplicationTarget;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigUpfrontTicksToPay: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigUpfrontTicksToPay;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigUpperExponentFactor: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigUpperExponentFactor;
    ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigZeroSizeBucketFixedRate: ShrParachainConfigsRuntimeParamsDynamicParamsRuntimeConfigZeroSizeBucketFixedRate;
    ShrParachainConfigsRuntimeParamsRuntimeParameters: ShrParachainConfigsRuntimeParamsRuntimeParameters;
    ShrParachainConfigsRuntimeParamsRuntimeParametersKey: ShrParachainConfigsRuntimeParamsRuntimeParametersKey;
    ShrParachainConfigsRuntimeParamsRuntimeParametersValue: ShrParachainConfigsRuntimeParamsRuntimeParametersValue;
    ShrParachainRuntime: ShrParachainRuntime;
    ShrParachainRuntimeHoldReason: ShrParachainRuntimeHoldReason;
    ShrParachainSessionKeys: ShrParachainSessionKeys;
