...
import type { BackupStorageProvider, BackupStorageProviderId, ChunkId, FileMetadata, GetBspInfoError, IncompleteFileStatus, MerklePatriciaRoot, QueryBspConfirmChunksToProveForFileError, QueryFileEarliestVolunteerBlockError, SaveFileToDisk } from '@storagehub/api-augment/interfaces/storagehubclient';
