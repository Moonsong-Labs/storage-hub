...
declare module "@polkadot/types/lookup" {
  ...
  /** @name ShpTraitsTrieRemoveMutation (155) */
  type ShpTraitsTrieRemoveMutation = Null;
  /** @name ShpTraitsTrieMutation (159) */
  ...
  /** @name ShpTraitsTrieAddMutation (160) */
  ...
  /** @name PalletCrRandomnessEvent (165) */
  interface PalletCrRandomnessEvent extends Enum {
    readonly isProviderCycleInitialised: boolean;
    readonly asProviderCycleInitialised: {
      readonly providerId: H256;
      readonly firstSeedCommitmentDeadlineTick: u32;
    } & Struct;
    readonly isProviderCycleStopped: boolean;
    readonly asProviderCycleStopped: {
      readonly providerId: H256;
    } & Struct;
    readonly isProviderInitialisedRandomness: boolean;
    readonly asProviderInitialisedRandomness: {
    ...
    readonly asRandomnessCommitted: {
      ...
      readonly validFromTick: u32;
      readonly newSeedCommitment: H256;
      readonly nextDeadlineTick: u32;
    } & Struct;
    readonly type:
  ...
  /** @name PalletNftsAttributeNamespace (170) */
  ...
  /** @name PalletParametersEvent (175) */
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsRuntimeParametersKey (176) */
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigParametersKey (177) */
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSlashAmountPerMaxFileSize (178) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSlashAmountPerMaxFileSize =
    Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigStakeToChallengePeriod (179) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigStakeToChallengePeriod = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigCheckpointChallengePeriod (180) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigCheckpointChallengePeriod =
    Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinChallengePeriod (181) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinChallengePeriod = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationLowerThresholdPercentage (182) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationLowerThresholdPercentage =
    Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationUpperThresholdPercentage (183) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationUpperThresholdPercentage =
    Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMostlyStablePrice (184) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMostlyStablePrice = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxPrice (185) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxPrice = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinPrice (186) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinPrice = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigUpperExponentFactor (187) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigUpperExponentFactor = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigLowerExponentFactor (188) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigLowerExponentFactor = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigZeroSizeBucketFixedRate (189) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigZeroSizeBucketFixedRate =
    Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigIdealUtilisationRate (190) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigIdealUtilisationRate = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigDecayRate (191) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigDecayRate = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinimumTreasuryCut (192) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinimumTreasuryCut = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaximumTreasuryCut (193) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaximumTreasuryCut = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigBspStopStoringFilePenalty (194) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigBspStopStoringFilePenalty =
    Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinSeedPeriod (195) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinSeedPeriod = Null;
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigStakeToSeedPeriod (196) */
  ...
  /** @name PalletFileSystemHoldReason (276) */
  ...
  /** @name PalletFileSystemStorageRequestMspBucketResponse (341) */
  ...
  /** @name PalletFileSystemStorageRequestMspAcceptedFileKeys (343) */
  ...
  /** @name PalletFileSystemFileKeyWithProof (345) */
  ...
  /** @name PalletCrRandomnessCall (360) */
  interface PalletCrRandomnessCall extends Enum {
    readonly isAddRandomness: boolean;
    readonly asAddRandomness: {
      readonly providerId: H256;
      readonly commitmentWithSeedToReveal: Option<PalletCrRandomnessCommitmentWithSeed>;
      readonly newSeedCommitment: H256;
    } & Struct;
    readonly isForceInitialiseProviderCycle: boolean;
    readonly asForceInitialiseProviderCycle: {
      readonly providerId: H256;
    } & Struct;
    readonly isForceStopProviderCycle: boolean;
    readonly asForceStopProviderCycle: {
      readonly providerId: H256;
    } & Struct;
    readonly type: "AddRandomness" | "ForceInitialiseProviderCycle" | "ForceStopProviderCycle";
  }
  /** @name PalletCrRandomnessCommitmentWithSeed (362) */
  interface PalletCrRandomnessCommitmentWithSeed extends Struct {
    readonly commitment: H256;
    readonly seed: H256;
  }
  /** @name PalletNftsCall (363) */
  ...
  /** @name PalletNftsMintSettings (367) */
  ...
  /** @name PalletNftsItemSetting (371) */
  ...
  /** @name PalletNftsPreSignedMint (381) */
  ...
  /** @name SpRuntimeMultiSignature (382) */
  ...
  /** @name PalletNftsPreSignedAttributes (385) */
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsRuntimeParameters (387) */
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigParameters (388) */
  ...
  /** @name PalletSudoError (390) */
  interface PalletSudoError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: "RequireSudo";
  }
  /** @name PalletCollatorSelectionCandidateInfo (393) */
  interface PalletCollatorSelectionCandidateInfo extends Struct {
    readonly who: AccountId32;
    readonly deposit: u128;
  }
  /** @name PalletCollatorSelectionError (395) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundChannelDetails (409) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundState (410) */
  ...
  /** @name PalletXcmVersionMigrationStage (426) */
  ...
  /** @name PalletXcmRemoteLockedFungibleRecord (429) */
  ...
  /** @name PalletMessageQueueBookState (437) */
  ...
  /** @name PalletMessageQueueNeighbours (439) */
  ...
  /** @name PalletMessageQueuePage (441) */
  ...
  /** @name PalletMessageQueueError (443) */
  ...
  /** @name PalletStorageProvidersSignUpRequest (444) */
  ...
  /** @name PalletStorageProvidersSignUpRequestSpParams (445) */
  ...
  /** @name PalletStorageProvidersBackupStorageProvider (446) */
  ...
  /** @name PalletStorageProvidersMainStorageProviderSignUpRequest (447) */
  ...
  /** @name PalletStorageProvidersMainStorageProvider (448) */
  ...
  /** @name PalletStorageProvidersBucket (449) */
  ...
  /** @name PalletStorageProvidersError (452) */
  ...
  /** @name PalletFileSystemStorageRequestMetadata (453) */
  ...
  /** @name PalletFileSystemStorageRequestBspsMetadata (456) */
  interface PalletFileSystemStorageRequestBspsMetadata extends Struct {
    readonly confirmed: bool;
  }
  /** @name PalletFileSystemPendingFileDeletionRequest (459) */
  ...
  /** @name PalletCrRandomnessError (480) */
  interface PalletCrRandomnessError extends Enum {
    readonly isProviderIdNotValid: boolean;
    readonly isCallerNotOwner: boolean;
    readonly isNotAValidSeed: boolean;
    readonly isNoEndTickForSeedCommitment: boolean;
    readonly isEarlySubmissionOfSeed: boolean;
    readonly isLateSubmissionOfSeed: boolean;
    readonly isMissingSeedReveal: boolean;
    readonly isNewCommitmentAlreadyPending: boolean;
    readonly isUnableToConvertTickNumberForArithmetic: boolean;
    readonly isQueueError: boolean;
    readonly asQueueError: PalletCrRandomnessQueueQueueError;
    readonly type:
      | "ProviderIdNotValid"
      | "CallerNotOwner"
      | "NotAValidSeed"
  ...
  /** @name PalletCrRandomnessQueueQueueError (481) */
  interface PalletCrRandomnessQueueQueueError extends Enum {
    readonly isIndexOutOfRange: boolean;
