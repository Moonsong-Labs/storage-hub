...
declare module "@polkadot/types/lookup" {
  ...
  /** @name FrameSystemCodeUpgradeAuthorization (210) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentAncestor (228) */
  interface CumulusPalletParachainSystemUnincludedSegmentAncestor extends Struct {
    readonly usedBandwidth: CumulusPalletParachainSystemUnincludedSegmentUsedBandwidth;
    readonly paraHeadHash: Option<H256>;
    readonly consumedGoAheadSignal: Option<PolkadotPrimitivesV8UpgradeGoAhead>;
  }
  /** @name CumulusPalletParachainSystemUnincludedSegmentUsedBandwidth (229) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentHrmpChannelUpdate (231) */
  ...
  /** @name PalletPaymentStreamsHoldReason (281) */
  ...
  /** @name FrameSupportTokensMiscIdAmount (284) */
  ...
  /** @name PalletBalancesAdjustmentDirection (289) */
  ...
  /** @name PalletCollatorSelectionCall (294) */
  ...
  /** @name StorageHubRuntimeSessionKeys (296) */
  ...
  /** @name CumulusPalletXcmpQueueCall (298) */
  ...
  /** @name XcmV3QueryResponseInfo (322) */
  interface XcmV3QueryResponseInfo extends Struct {
    readonly destination: StagingXcmV3MultiLocation;
    readonly queryId: Compact<u64>;
    readonly maxWeight: SpWeightsWeightV2Weight;
  }
  /** @name XcmV3MultiassetMultiAssetFilter (323) */
  ...
  /** @name XcmV3MultiassetWildMultiAsset (324) */
  ...
  /** @name XcmV3MultiassetWildFungibility (325) */
  interface XcmV3MultiassetWildFungibility extends Enum {
    readonly isFungible: boolean;
    readonly isNonFungible: boolean;
    readonly type: "Fungible" | "NonFungible";
  }
  /** @name StagingXcmExecutorAssetTransferTransferType (337) */
  ...
  /** @name CumulusPalletXcmCall (339) */
  type CumulusPalletXcmCall = Null;
  /** @name PalletMessageQueueCall (340) */
  ...
  /** @name PalletStorageProvidersCall (341) */
  ...
  /** @name PalletFileSystemBucketMoveRequestResponse (343) */
  interface PalletFileSystemBucketMoveRequestResponse extends Enum {
    readonly isAccepted: boolean;
    readonly isRejected: boolean;
    readonly type: "Accepted" | "Rejected";
  }
  /** @name PalletFileSystemMspStorageRequestResponse (346) */
  ...
  /** @name PalletFileSystemAcceptedStorageRequestParameters (348) */
  ...
  /** @name PalletXcmRemoteLockedFungibleRecord (427) */
  ...
  /** @name PalletMessageQueueBookState (435) */
  ...
  /** @name PalletMessageQueueNeighbours (437) */
  ...
  /** @name PalletMessageQueuePage (439) */
  ...
  /** @name PalletMessageQueueError (441) */
  ...
  /** @name PalletStorageProvidersStorageProvider (443) */
  ...
  /** @name PalletStorageProvidersBackupStorageProvider (444) */
  ...
  /** @name PalletStorageProvidersBucket (447) */
