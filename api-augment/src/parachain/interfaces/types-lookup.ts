...
declare module "@polkadot/types/lookup" {
  ...
  interface ShParachainRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigParameters
    ...
    readonly asMaxBspVolunteers: ITuple<
      [
        ShParachainRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxBspVolunteers,
        Option<u32>
      ]
    >;
    readonly isMaxMspRespondFileKeys: boolean;
    readonly asMaxMspRespondFileKeys: ITuple<
      [
        ShParachainRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxMspRespondFileKeys,
        Option<u32>
      ]
    >;
    readonly type:
