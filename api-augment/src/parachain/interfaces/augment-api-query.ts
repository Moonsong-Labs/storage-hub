...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    parameters: {
       ...
       * Stored parameters.
       **/
      parameters: AugmentedQuery<ApiType, (arg: ShParachainRuntimeConfigsRuntimeParamsRuntimeParametersKey | { RuntimeConfig: any } | string | Uint8Array) => Observable<Option<ShParachainRuntimeConfigsRuntimeParamsRuntimeParametersValue>>, [ShParachainRuntimeConfigsRuntimeParamsRuntimeParametersKey]> & QueryableStorageEntry<ApiType, [ShParachainRuntimeConfigsRuntimeParamsRuntimeParametersKey]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
