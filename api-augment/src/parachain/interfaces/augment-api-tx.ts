...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    bucketNfts: {
       ...
       **/
      shareAccess: AugmentedSubmittable<(recipient: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, bucket: H256 | string | Uint8Array, itemId: u32 | AnyNumber | Uint8Array, readAccessRegex: Option<Bytes> | null | Uint8Array | Bytes | string) => SubmittableExtrinsic<ApiType>, [MultiAddress, H256, u32, Option<Bytes>]>;
      /**
    ...
    fileSystem: {
       ...
       **/
      deleteFile: AugmentedSubmittable<(fileOwner: AccountId32 | string | Uint8Array, signedIntention: PalletFileSystemFileOperationIntention | { fileKey?: any; operation?: any } | string | Uint8Array, signature: SpRuntimeMultiSignature | { Ed25519: any } | { Sr25519: any } | { Ecdsa: any } | string | Uint8Array, bucketId: H256 | string | Uint8Array, location: Bytes | string | Uint8Array, size: u64 | AnyNumber | Uint8Array, fingerprint: H256 | string | Uint8Array, providerId: H256 | string | Uint8Array, forestProof: SpTrieStorageProofCompactProof | { encodedNodes?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PalletFileSystemFileOperationIntention, SpRuntimeMultiSignature, H256, Bytes, u64, H256, H256, SpTrieStorageProofCompactProof]>;
      /**
    ...
    parameters: {
       ...
       **/
      setParameter: AugmentedSubmittable<(keyValue: ShParachainRuntimeConfigsRuntimeParamsRuntimeParameters | { RuntimeConfig: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ShParachainRuntimeConfigsRuntimeParamsRuntimeParameters]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    session: {
       ...
       * fixed.
       **/
      setKeys: AugmentedSubmittable<(keys: ShParachainRuntimeSessionKeys | { aura?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ShParachainRuntimeSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
