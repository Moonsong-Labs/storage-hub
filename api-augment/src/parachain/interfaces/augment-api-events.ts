...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    bucketNfts: {
       ...
       **/
      AccessShared: AugmentedEvent<ApiType, [issuer: AccountId32, recipient: AccountId32], { issuer: AccountId32, recipient: AccountId32 }>;
      /**
       * Notifies that an item has been burned.
       **/
      ItemBurned: AugmentedEvent<ApiType, [account: AccountId32, bucket: H256, itemId: u32], { account: AccountId32, bucket: H256, itemId: u32 }>;
      /**
       * Notifies that the read access for an item has been updated.
       **/
      ItemReadAccessUpdated: AugmentedEvent<ApiType, [admin: AccountId32, bucket: H256, itemId: u32], { admin: AccountId32, bucket: H256, itemId: u32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    fileSystem: {
       ...
       **/
      AcceptedBspVolunteer: AugmentedEvent<ApiType, [bspId: H256, bucketId: H256, location: Bytes, fingerprint: H256, multiaddresses: Vec<Bytes>, owner: AccountId32, size_: u64], { bspId: H256, bucketId: H256, location: Bytes, fingerprint: H256, multiaddresses: Vec<Bytes>, owner: AccountId32, size_: u64 }>;
      /**
       ...
       **/
      BspChallengeCycleInitialised: AugmentedEvent<ApiType, [who: AccountId32, bspId: H256], { who: AccountId32, bspId: H256 }>;
      /**
       * Notifies that a BSP confirmed storing a file(s).
       **/
      BspConfirmedStoring: AugmentedEvent<ApiType, [who: AccountId32, bspId: H256, confirmedFileKeys: Vec<ITuple<[H256, ShpFileMetadataFileMetadata]>>, skippedFileKeys: Vec<H256>, newRoot: H256], { who: AccountId32, bspId: H256, confirmedFileKeys: Vec<ITuple<[H256, ShpFileMetadataFileMetadata]>>, skippedFileKeys: Vec<H256>, newRoot: H256 }>;
      /**
       ...
       **/
      BspFileDeletionCompleted: AugmentedEvent<ApiType, [user: AccountId32, fileKey: H256, fileSize: u64, bspId: H256, oldRoot: H256, newRoot: H256], { user: AccountId32, fileKey: H256, fileSize: u64, bspId: H256, oldRoot: H256, newRoot: H256 }>;
      BspRequestedToStopStoring: AugmentedEvent<ApiType, [bspId: H256, fileKey: H256, owner: AccountId32, location: Bytes], { bspId: H256, fileKey: H256, owner: AccountId32, location: Bytes }>;
      /**
       * Notifies that an empty bucket has been deleted.
       **/
      BucketDeleted: AugmentedEvent<ApiType, [who: AccountId32, bucketId: H256, maybeCollectionId: Option<u32>], { who: AccountId32, bucketId: H256, maybeCollectionId: Option<u32> }>;
      /**
       * Notifies that a bucket's privacy has been updated.
       **/
      BucketPrivacyUpdated: AugmentedEvent<ApiType, [who: AccountId32, bucketId: H256, collectionId: Option<u32>, private: bool], { who: AccountId32, bucketId: H256, collectionId: Option<u32>, private: bool }>;
      /**
       * Failed to decrease MSP's used capacity for expired file deletion request
       **/
      FailedToDecreaseMspUsedCapacity: AugmentedEvent<ApiType, [user: AccountId32, mspId: H256, fileKey: H256, fileSize: u64, error: SpRuntimeDispatchError], { user: AccountId32, mspId: H256, fileKey: H256, fileSize: u64, error: SpRuntimeDispatchError }>;
      /**
       ...
       **/
      FailedToReleaseStorageRequestCreationDeposit: AugmentedEvent<ApiType, [fileKey: H256, owner: AccountId32, amountToReturn: u128, error: SpRuntimeDispatchError], { fileKey: H256, owner: AccountId32, amountToReturn: u128, error: SpRuntimeDispatchError }>;
      /**
       * Event to notify if, in the `on_idle` hook when cleaning up an expired storage request,
       * the transfer of a part of that storage request's deposit to one of the volunteered BSPs failed.
       **/
      FailedToTransferDepositFundsToBsp: AugmentedEvent<ApiType, [fileKey: H256, owner: AccountId32, bspId: H256, amountToTransfer: u128, error: SpRuntimeDispatchError], { fileKey: H256, owner: AccountId32, bspId: H256, amountToTransfer: u128, error: SpRuntimeDispatchError }>;
      /**
       ...
       **/
      FileDeletionRequest: AugmentedEvent<ApiType, [user: AccountId32, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool], { user: AccountId32, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool }>;
      /**
       ...
       **/
      FileDeletionRequested: AugmentedEvent<ApiType, [signedDeleteIntention: PalletFileSystemFileOperationIntention, signature: SpRuntimeMultiSignature], { signedDeleteIntention: PalletFileSystemFileOperationIntention, signature: SpRuntimeMultiSignature }>;
      /**
       ...
       **/
      MoveBucketRequested: AugmentedEvent<ApiType, [who: AccountId32, bucketId: H256, newMspId: H256, newValuePropId: H256], { who: AccountId32, bucketId: H256, newMspId: H256, newValuePropId: H256 }>;
      /**
       ...
       **/
      MspFileDeletionCompleted: AugmentedEvent<ApiType, [user: AccountId32, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, oldRoot: H256, newRoot: H256], { user: AccountId32, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, oldRoot: H256, newRoot: H256 }>;
      /**
       * Notifies that a MSP has stopped storing a bucket.
       **/
      MspStoppedStoringBucket: AugmentedEvent<ApiType, [mspId: H256, owner: AccountId32, bucketId: H256], { mspId: H256, owner: AccountId32, bucketId: H256 }>;
      /**
       * Notifies that a MSP has stopped storing a bucket because its owner has become insolvent.
       **/
      MspStopStoringBucketInsolventUser: AugmentedEvent<ApiType, [mspId: H256, owner: AccountId32, bucketId: H256], { mspId: H256, owner: AccountId32, bucketId: H256 }>;
      /**
       * Notifies that a new bucket has been created.
       **/
      NewBucket: AugmentedEvent<ApiType, [who: AccountId32, mspId: H256, bucketId: H256, name: Bytes, root: H256, collectionId: Option<u32>, private: bool, valuePropId: H256], { who: AccountId32, mspId: H256, bucketId: H256, name: Bytes, root: H256, collectionId: Option<u32>, private: bool, valuePropId: H256 }>;
      /**
       * Notifies that a new collection has been created and associated with a bucket.
       **/
      NewCollectionAndAssociation: AugmentedEvent<ApiType, [who: AccountId32, bucketId: H256, collectionId: u32], { who: AccountId32, bucketId: H256, collectionId: u32 }>;
      /**
       * Notifies that a new file has been requested to be stored.
       **/
      NewStorageRequest: AugmentedEvent<ApiType, [who: AccountId32, fileKey: H256, bucketId: H256, location: Bytes, fingerprint: H256, size_: u64, peerIds: Vec<Bytes>, expiresAt: u32], { who: AccountId32, fileKey: H256, bucketId: H256, location: Bytes, fingerprint: H256, size_: u64, peerIds: Vec<Bytes>, expiresAt: u32 }>;
      /**
       ...
       **/
      ProofSubmittedForPendingFileDeletionRequest: AugmentedEvent<ApiType, [user: AccountId32, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool], { user: AccountId32, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool }>;
      /**
       * Notifies that a SP has stopped storing a file because its owner has become insolvent.
       **/
      SpStopStoringInsolventUser: AugmentedEvent<ApiType, [spId: H256, fileKey: H256, owner: AccountId32, location: Bytes, newRoot: H256], { spId: H256, fileKey: H256, owner: AccountId32, location: Bytes, newRoot: H256 }>;
      /**
    ...
    parameters: {
       ...
       **/
      Updated: AugmentedEvent<ApiType, [key: ShParachainRuntimeConfigsRuntimeParamsRuntimeParametersKey, oldValue: Option<ShParachainRuntimeConfigsRuntimeParamsRuntimeParametersValue>, newValue: Option<ShParachainRuntimeConfigsRuntimeParamsRuntimeParametersValue>], { key: ShParachainRuntimeConfigsRuntimeParamsRuntimeParametersKey, oldValue: Option<ShParachainRuntimeConfigsRuntimeParamsRuntimeParametersValue>, newValue: Option<ShParachainRuntimeConfigsRuntimeParamsRuntimeParametersValue> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    paymentStreams: {
       ...
       **/
      DynamicRatePaymentStreamCreated: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256, amountProvided: u64], { userAccount: AccountId32, providerId: H256, amountProvided: u64 }>;
      /**
       ...
       **/
      DynamicRatePaymentStreamDeleted: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256], { userAccount: AccountId32, providerId: H256 }>;
      /**
       ...
       **/
      DynamicRatePaymentStreamUpdated: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256, newAmountProvided: u64], { userAccount: AccountId32, providerId: H256, newAmountProvided: u64 }>;
      /**
       ...
       **/
      FixedRatePaymentStreamCreated: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256, rate: u128], { userAccount: AccountId32, providerId: H256, rate: u128 }>;
      /**
       * Event emitted when a fixed-rate payment stream is removed. Provides information about the User and Provider of the stream.
       **/
      FixedRatePaymentStreamDeleted: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256], { userAccount: AccountId32, providerId: H256 }>;
      /**
       ...
       **/
      FixedRatePaymentStreamUpdated: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256, newRate: u128], { userAccount: AccountId32, providerId: H256, newRate: u128 }>;
      /**
       ...
       **/
      PaymentStreamCharged: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256, amount: u128, lastTickCharged: u32, chargedAtTick: u32], { userAccount: AccountId32, providerId: H256, amount: u128, lastTickCharged: u32, chargedAtTick: u32 }>;
      /**
       ...
       **/
      UsersCharged: AugmentedEvent<ApiType, [userAccounts: Vec<AccountId32>, providerId: H256, chargedAtTick: u32], { userAccounts: Vec<AccountId32>, providerId: H256, chargedAtTick: u32 }>;
      /**
    ...
    proofsDealer: {
       ...
       **/
      NewChallenge: AugmentedEvent<ApiType, [who: Option<AccountId32>, keyChallenged: H256], { who: Option<AccountId32>, keyChallenged: H256 }>;
      /**
       * A provider's challenge cycle was initialised.
       **/
      NewChallengeCycleInitialised: AugmentedEvent<ApiType, [currentTick: u32, nextChallengeDeadline: u32, provider: H256, maybeProviderAccount: Option<AccountId32>], { currentTick: u32, nextChallengeDeadline: u32, provider: H256, maybeProviderAccount: Option<AccountId32> }>;
      /**
       ...
       **/
      NewPriorityChallenge: AugmentedEvent<ApiType, [who: Option<AccountId32>, keyChallenged: H256, shouldRemoveKey: bool], { who: Option<AccountId32>, keyChallenged: H256, shouldRemoveKey: bool }>;
      /**
    ...
    providers: {
       ...
       **/
      BspRequestSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u64], { who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u64 }>;
      /**
       * Event emitted when a Backup Storage Provider has signed off successfully. Provides information about
       * that BSP's account id.
       **/
      BspSignOffSuccess: AugmentedEvent<ApiType, [who: AccountId32, bspId: H256], { who: AccountId32, bspId: H256 }>;
      /**
       ...
       **/
      BspSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId32, bspId: H256, root: H256, multiaddresses: Vec<Bytes>, capacity: u64], { who: AccountId32, bspId: H256, root: H256, multiaddresses: Vec<Bytes>, capacity: u64 }>;
      /**
       ...
       **/
      CapacityChanged: AugmentedEvent<ApiType, [who: AccountId32, providerId: PalletStorageProvidersStorageProviderId, oldCapacity: u64, newCapacity: u64, nextBlockWhenChangeAllowed: u32], { who: AccountId32, providerId: PalletStorageProvidersStorageProviderId, oldCapacity: u64, newCapacity: u64, nextBlockWhenChangeAllowed: u32 }>;
      /**
       ...
       **/
      MspRequestSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u64], { who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u64 }>;
      /**
       * Event emitted when a Main Storage Provider has signed off successfully. Provides information about
       * that MSP's account id.
       **/
      MspSignOffSuccess: AugmentedEvent<ApiType, [who: AccountId32, mspId: H256], { who: AccountId32, mspId: H256 }>;
      /**
       ...
       **/
      MspSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId32, mspId: H256, multiaddresses: Vec<Bytes>, capacity: u64, valueProp: PalletStorageProvidersValuePropositionWithId], { who: AccountId32, mspId: H256, multiaddresses: Vec<Bytes>, capacity: u64, valueProp: PalletStorageProvidersValuePropositionWithId }>;
      /**
