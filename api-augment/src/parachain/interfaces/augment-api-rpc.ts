...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  interface RpcInterface {
    ...
    storagehubclient: {
       ...
       **/
      addFilesToForestStorage: AugmentedRpc<(forest_key: Option<H256> | null | Uint8Array | H256 | string, metadata_of_files_to_add: Vec<FileMetadata> | (FileMetadata | { owner?: any; bucket_id?: any; location?: any; file_size?: any; fingerprint?: any } | string | Uint8Array)[]) => Observable<AddFilesToForestStorageResult>>;
      /**
       ...
       **/
      generateProof: AugmentedRpc<(provider_id: H256 | string | Uint8Array, seed: H256 | string | Uint8Array, checkpoint_challenges: Option<Vec<CheckpointChallenge>> | null | Uint8Array | Vec<CheckpointChallenge> | (CheckpointChallenge | { file_key?: any; should_remove_file?: any } | string | Uint8Array)[]) => Observable<Bytes>>;
      /**
