...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    fileSystem: {
       ...
       **/
      bspConfirmStopStoring: AugmentedSubmittable<(fileKey: H256 | string | Uint8Array, inclusionForestProof: SpTrieStorageProofCompactProof | { encodedNodes?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, SpTrieStorageProofCompactProof]>;
      /**
       * Used by a BSP to confirm they are storing data of a storage request.
       **/
      bspConfirmStoring: AugmentedSubmittable<(nonInclusionForestProof: SpTrieStorageProofCompactProof | { encodedNodes?: any } | string | Uint8Array, fileKeysAndProofs: Vec<PalletFileSystemFileKeyWithProof> | (PalletFileSystemFileKeyWithProof | { fileKey?: any; proof?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [SpTrieStorageProofCompactProof, Vec<PalletFileSystemFileKeyWithProof>]>;
      /**
       ...
       **/
      deleteFile: AugmentedSubmittable<(fileOwner: AccountId20 | string | Uint8Array, signedIntention: PalletFileSystemFileOperationIntention | { fileKey?: any; operation?: any } | string | Uint8Array, signature: FpAccountEthereumSignature | string | Uint8Array, bucketId: H256 | string | Uint8Array, location: Bytes | string | Uint8Array, size: u64 | AnyNumber | Uint8Array, fingerprint: H256 | string | Uint8Array, providerId: H256 | string | Uint8Array, forestProof: SpTrieStorageProofCompactProof | { encodedNodes?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, PalletFileSystemFileOperationIntention, FpAccountEthereumSignature, H256, Bytes, u64, H256, H256, SpTrieStorageProofCompactProof]>;
      /**
       ...
       **/
      deleteFileForIncompleteStorageRequest: AugmentedSubmittable<(fileKey: H256 | string | Uint8Array, providerId: H256 | string | Uint8Array, forestProof: SpTrieStorageProofCompactProof | { encodedNodes?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, H256, SpTrieStorageProofCompactProof]>;
      /**
       * Issue a new storage request for a file
       **/
      issueStorageRequest: AugmentedSubmittable<(bucketId: H256 | string | Uint8Array, location: Bytes | string | Uint8Array, fingerprint: H256 | string | Uint8Array, size: u64 | AnyNumber | Uint8Array, mspId: H256 | string | Uint8Array, peerIds: Vec<Bytes> | (Bytes | string | Uint8Array)[], replicationTarget: PalletFileSystemReplicationTarget | { Basic: any } | { Standard: any } | { HighSecurity: any } | { SuperHighSecurity: any } | { UltraHighSecurity: any } | { Custom: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, Bytes, H256, u64, H256, Vec<Bytes>, PalletFileSystemReplicationTarget]>;
    ...
    nfts: {
       ...
       **/
      cancelItemAttributesApproval: AugmentedSubmittable<(collection: u32 | AnyNumber | Uint8Array, item: u32 | AnyNumber | Uint8Array, delegate: AccountId20 | string | Uint8Array, witness: PalletNftsCancelAttributesApprovalWitness | { accountAttributes?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, AccountId20, PalletNftsCancelAttributesApprovalWitness]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      create: AugmentedSubmittable<(admin: AccountId20 | string | Uint8Array, config: PalletNftsCollectionConfig | { settings?: any; maxSupply?: any; mintSettings?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, PalletNftsCollectionConfig]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      forceCreate: AugmentedSubmittable<(owner: AccountId20 | string | Uint8Array, config: PalletNftsCollectionConfig | { settings?: any; maxSupply?: any; mintSettings?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, PalletNftsCollectionConfig]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      forceMint: AugmentedSubmittable<(collection: u32 | AnyNumber | Uint8Array, item: u32 | AnyNumber | Uint8Array, mintTo: AccountId20 | string | Uint8Array, itemConfig: PalletNftsItemConfig | { settings?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, AccountId20, PalletNftsItemConfig]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      forceSetAttribute: AugmentedSubmittable<(setAs: Option<AccountId20> | null | Uint8Array | AccountId20 | string, collection: u32 | AnyNumber | Uint8Array, maybeItem: Option<u32> | null | Uint8Array | u32 | AnyNumber, namespace: PalletNftsAttributeNamespace | { Pallet: any } | { CollectionOwner: any } | { ItemOwner: any } | { Account: any } | string | Uint8Array, key: Bytes | string | Uint8Array, value: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<AccountId20>, u32, Option<u32>, PalletNftsAttributeNamespace, Bytes, Bytes]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      mint: AugmentedSubmittable<(collection: u32 | AnyNumber | Uint8Array, item: u32 | AnyNumber | Uint8Array, mintTo: AccountId20 | string | Uint8Array, witnessData: Option<PalletNftsMintWitness> | null | Uint8Array | PalletNftsMintWitness | { ownedItem?: any; mintPrice?: any } | string) => SubmittableExtrinsic<ApiType>, [u32, u32, AccountId20, Option<PalletNftsMintWitness>]>;
      /**
       ...
       **/
      mintPreSigned: AugmentedSubmittable<(mintData: PalletNftsPreSignedMint | { collection?: any; item?: any; attributes?: any; metadata?: any; onlyAccount?: any; deadline?: any; mintPrice?: any } | string | Uint8Array, signature: FpAccountEthereumSignature | string | Uint8Array, signer: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletNftsPreSignedMint, FpAccountEthereumSignature, AccountId20]>;
      /**
       ...
       **/
      setAttributesPreSigned: AugmentedSubmittable<(data: PalletNftsPreSignedAttributes | { collection?: any; item?: any; attributes?: any; namespace?: any; deadline?: any } | string | Uint8Array, signature: FpAccountEthereumSignature | string | Uint8Array, signer: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletNftsPreSignedAttributes, FpAccountEthereumSignature, AccountId20]>;
      /**
    ...
    parameters: {
       ...
       **/
      setParameter: AugmentedSubmittable<(keyValue: ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParameters | { RuntimeConfig: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParameters]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    proofsDealer: {
       ...
       **/
      submitProof: AugmentedSubmittable<(proof: PalletProofsDealerProof | { forestProof?: any; keyProofs?: any } | string | Uint8Array, provider: Option<H256> | null | Uint8Array | H256 | string) => SubmittableExtrinsic<ApiType>, [PalletProofsDealerProof, Option<H256>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    session: {
       ...
       * fixed.
       **/
      setKeys: AugmentedSubmittable<(keys: ShSolochainEvmRuntimeSessionKeys | { babe?: any; grandpa?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ShSolochainEvmRuntimeSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
