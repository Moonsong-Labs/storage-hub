...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    bucketNfts: {
       ...
       **/
      AccessShared: AugmentedEvent<ApiType, [issuer: AccountId20, recipient: AccountId20], { issuer: AccountId20, recipient: AccountId20 }>;
      /**
       * Notifies that an item has been burned.
       **/
      ItemBurned: AugmentedEvent<ApiType, [account: AccountId20, bucket: H256, itemId: u32], { account: AccountId20, bucket: H256, itemId: u32 }>;
      /**
       * Notifies that the read access for an item has been updated.
       **/
      ItemReadAccessUpdated: AugmentedEvent<ApiType, [admin: AccountId20, bucket: H256, itemId: u32], { admin: AccountId20, bucket: H256, itemId: u32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    fileSystem: {
       ...
       **/
      AcceptedBspVolunteer: AugmentedEvent<ApiType, [bspId: H256, bucketId: H256, location: Bytes, fingerprint: H256, multiaddresses: Vec<Bytes>, owner: AccountId20, size_: u64], { bspId: H256, bucketId: H256, location: Bytes, fingerprint: H256, multiaddresses: Vec<Bytes>, owner: AccountId20, size_: u64 }>;
      /**
       ...
       **/
      BspChallengeCycleInitialised: AugmentedEvent<ApiType, [who: AccountId20, bspId: H256], { who: AccountId20, bspId: H256 }>;
      /**
       * Notifies that a BSP confirmed storing a file(s).
       **/
      BspConfirmedStoring: AugmentedEvent<ApiType, [who: AccountId20, bspId: H256, confirmedFileKeys: Vec<ITuple<[H256, ShpFileMetadataFileMetadata]>>, skippedFileKeys: Vec<H256>, newRoot: H256], { who: AccountId20, bspId: H256, confirmedFileKeys: Vec<ITuple<[H256, ShpFileMetadataFileMetadata]>>, skippedFileKeys: Vec<H256>, newRoot: H256 }>;
      /**
       * Notifies that a BSP has stopped storing a file.
       **/
      BspConfirmStoppedStoring: AugmentedEvent<ApiType, [bspId: H256, fileKey: H256, newRoot: H256], { bspId: H256, fileKey: H256, newRoot: H256 }>;
      /**
       * Notifies that a file deletion has been completed successfully for a BSP.
       **/
      BspFileDeletionCompleted: AugmentedEvent<ApiType, [user: AccountId20, fileKey: H256, fileSize: u64, bspId: H256, oldRoot: H256, newRoot: H256], { user: AccountId20, fileKey: H256, fileSize: u64, bspId: H256, oldRoot: H256, newRoot: H256 }>;
      BspRequestedToStopStoring: AugmentedEvent<ApiType, [bspId: H256, fileKey: H256, owner: AccountId20, location: Bytes], { bspId: H256, fileKey: H256, owner: AccountId20, location: Bytes }>;
      /**
       * Notifies that an empty bucket has been deleted.
       **/
      BucketDeleted: AugmentedEvent<ApiType, [who: AccountId20, bucketId: H256, maybeCollectionId: Option<u32>], { who: AccountId20, bucketId: H256, maybeCollectionId: Option<u32> }>;
      /**
       * Notifies that a bucket's privacy has been updated.
       **/
      BucketPrivacyUpdated: AugmentedEvent<ApiType, [who: AccountId20, bucketId: H256, collectionId: Option<u32>, private: bool], { who: AccountId20, bucketId: H256, collectionId: Option<u32>, private: bool }>;
      /**
       * Failed to decrease MSP's used capacity for expired file deletion request
       **/
      FailedToDecreaseMspUsedCapacity: AugmentedEvent<ApiType, [user: AccountId20, mspId: H256, fileKey: H256, fileSize: u64, error: SpRuntimeDispatchError], { user: AccountId20, mspId: H256, fileKey: H256, fileSize: u64, error: SpRuntimeDispatchError }>;
      /**
       ...
       **/
      FailedToGetMspOfBucket: AugmentedEvent<ApiType, [bucketId: H256, error: SpRuntimeDispatchError], { bucketId: H256, error: SpRuntimeDispatchError }>;
      /**
       ...
       **/
      FailedToQueuePriorityChallenge: AugmentedEvent<ApiType, [fileKey: H256, error: SpRuntimeDispatchError], { fileKey: H256, error: SpRuntimeDispatchError }>;
      /**
       ...
       **/
      FailedToReleaseStorageRequestCreationDeposit: AugmentedEvent<ApiType, [fileKey: H256, owner: AccountId20, amountToReturn: u128, error: SpRuntimeDispatchError], { fileKey: H256, owner: AccountId20, amountToReturn: u128, error: SpRuntimeDispatchError }>;
      /**
       * Event to notify if, in the `on_idle` hook when cleaning up an expired storage request,
       * the transfer of a part of that storage request's deposit to one of the volunteered BSPs failed.
       **/
      FailedToTransferDepositFundsToBsp: AugmentedEvent<ApiType, [fileKey: H256, owner: AccountId20, bspId: H256, amountToTransfer: u128, error: SpRuntimeDispatchError], { fileKey: H256, owner: AccountId20, bspId: H256, amountToTransfer: u128, error: SpRuntimeDispatchError }>;
      /**
       * Notifies that a file has been deleted from a rejected storage request.
       **/
      FileDeletedFromIncompleteStorageRequest: AugmentedEvent<ApiType, [fileKey: H256, providerId: H256], { fileKey: H256, providerId: H256 }>;
      /**
       * Notifies that a file will be deleted.
       **/
      FileDeletionRequest: AugmentedEvent<ApiType, [user: AccountId20, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool], { user: AccountId20, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool }>;
      /**
       ...
       **/
      FileDeletionRequested: AugmentedEvent<ApiType, [signedDeleteIntention: PalletFileSystemFileOperationIntention, signature: FpAccountEthereumSignature], { signedDeleteIntention: PalletFileSystemFileOperationIntention, signature: FpAccountEthereumSignature }>;
      /**
       * Notifies that a bucket has been moved to a new MSP under a new value proposition.
       **/
      MoveBucketAccepted: AugmentedEvent<ApiType, [bucketId: H256, oldMspId: Option<H256>, newMspId: H256, valuePropId: H256], { bucketId: H256, oldMspId: Option<H256>, newMspId: H256, valuePropId: H256 }>;
      /**
       * Notifies that a bucket move request has been rejected by the MSP.
       **/
      MoveBucketRejected: AugmentedEvent<ApiType, [bucketId: H256, oldMspId: Option<H256>, newMspId: H256], { bucketId: H256, oldMspId: Option<H256>, newMspId: H256 }>;
      /**
       * Notifies that a bucket is being moved to a new MSP.
       **/
      MoveBucketRequested: AugmentedEvent<ApiType, [who: AccountId20, bucketId: H256, newMspId: H256, newValuePropId: H256], { who: AccountId20, bucketId: H256, newMspId: H256, newValuePropId: H256 }>;
      /**
       ...
       **/
      MspAcceptedStorageRequest: AugmentedEvent<ApiType, [fileKey: H256, fileMetadata: ShpFileMetadataFileMetadata], { fileKey: H256, fileMetadata: ShpFileMetadataFileMetadata }>;
      /**
       * Notifies that a file deletion has been completed successfully for an MSP.
       **/
      MspFileDeletionCompleted: AugmentedEvent<ApiType, [user: AccountId20, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, oldRoot: H256, newRoot: H256], { user: AccountId20, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, oldRoot: H256, newRoot: H256 }>;
      /**
       * Notifies that a MSP has stopped storing a bucket.
       **/
      MspStoppedStoringBucket: AugmentedEvent<ApiType, [mspId: H256, owner: AccountId20, bucketId: H256], { mspId: H256, owner: AccountId20, bucketId: H256 }>;
      /**
       * Notifies that a MSP has stopped storing a bucket because its owner has become insolvent.
       **/
      MspStopStoringBucketInsolventUser: AugmentedEvent<ApiType, [mspId: H256, owner: AccountId20, bucketId: H256], { mspId: H256, owner: AccountId20, bucketId: H256 }>;
      /**
       * Notifies that a new bucket has been created.
       **/
      NewBucket: AugmentedEvent<ApiType, [who: AccountId20, mspId: H256, bucketId: H256, name: Bytes, root: H256, collectionId: Option<u32>, private: bool, valuePropId: H256], { who: AccountId20, mspId: H256, bucketId: H256, name: Bytes, root: H256, collectionId: Option<u32>, private: bool, valuePropId: H256 }>;
      /**
       * Notifies that a new collection has been created and associated with a bucket.
       **/
      NewCollectionAndAssociation: AugmentedEvent<ApiType, [who: AccountId20, bucketId: H256, collectionId: u32], { who: AccountId20, bucketId: H256, collectionId: u32 }>;
      /**
       * Notifies that a new file has been requested to be stored.
       **/
      NewStorageRequest: AugmentedEvent<ApiType, [who: AccountId20, fileKey: H256, bucketId: H256, location: Bytes, fingerprint: H256, size_: u64, peerIds: Vec<Bytes>, expiresAt: u32], { who: AccountId20, fileKey: H256, bucketId: H256, location: Bytes, fingerprint: H256, size_: u64, peerIds: Vec<Bytes>, expiresAt: u32 }>;
      /**
       * Notifies that a file key has been queued for a priority challenge for file deletion.
       **/
      PriorityChallengeForFileDeletionQueued: AugmentedEvent<ApiType, [issuer: PalletFileSystemEitherAccountIdOrMspId, fileKey: H256], { issuer: PalletFileSystemEitherAccountIdOrMspId, fileKey: H256 }>;
      /**
       * Notifies that a proof has been submitted for a pending file deletion request.
       **/
      ProofSubmittedForPendingFileDeletionRequest: AugmentedEvent<ApiType, [user: AccountId20, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool], { user: AccountId20, fileKey: H256, fileSize: u64, bucketId: H256, mspId: H256, proofOfInclusion: bool }>;
      /**
       * Notifies that a SP has stopped storing a file because its owner has become insolvent.
       **/
      SpStopStoringInsolventUser: AugmentedEvent<ApiType, [spId: H256, fileKey: H256, owner: AccountId20, location: Bytes, newRoot: H256], { spId: H256, fileKey: H256, owner: AccountId20, location: Bytes, newRoot: H256 }>;
      /**
       ...
       **/
      StorageRequestRejected: AugmentedEvent<ApiType, [fileKey: H256, reason: PalletFileSystemRejectedStorageRequestReason], { fileKey: H256, reason: PalletFileSystemRejectedStorageRequestReason }>;
      /**
       ...
       **/
      UsedCapacityShouldBeZero: AugmentedEvent<ApiType, [actualUsedCapacity: u64], { actualUsedCapacity: u64 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    nfts: {
       ...
       **/
      AllApprovalsCancelled: AugmentedEvent<ApiType, [collection: u32, item: u32, owner: AccountId20], { collection: u32, item: u32, owner: AccountId20 }>;
      /**
       * An approval for a `delegate` account to transfer the `item` of an item
       * `collection` was cancelled by its `owner`.
       **/
      ApprovalCancelled: AugmentedEvent<ApiType, [collection: u32, item: u32, owner: AccountId20, delegate: AccountId20], { collection: u32, item: u32, owner: AccountId20, delegate: AccountId20 }>;
      /**
       ...
       **/
      Burned: AugmentedEvent<ApiType, [collection: u32, item: u32, owner: AccountId20], { collection: u32, item: u32, owner: AccountId20 }>;
      /**
       ...
       **/
      Created: AugmentedEvent<ApiType, [collection: u32, creator: AccountId20, owner: AccountId20], { collection: u32, creator: AccountId20, owner: AccountId20 }>;
      /**
       ...
       **/
      ForceCreated: AugmentedEvent<ApiType, [collection: u32, owner: AccountId20], { collection: u32, owner: AccountId20 }>;
      /**
       * An `item` was issued.
       **/
      Issued: AugmentedEvent<ApiType, [collection: u32, item: u32, owner: AccountId20], { collection: u32, item: u32, owner: AccountId20 }>;
      /**
       * A new approval to modify item attributes was added.
       **/
      ItemAttributesApprovalAdded: AugmentedEvent<ApiType, [collection: u32, item: u32, delegate: AccountId20], { collection: u32, item: u32, delegate: AccountId20 }>;
      /**
       * A new approval to modify item attributes was removed.
       **/
      ItemAttributesApprovalRemoved: AugmentedEvent<ApiType, [collection: u32, item: u32, delegate: AccountId20], { collection: u32, item: u32, delegate: AccountId20 }>;
      /**
       * An item was bought.
       **/
      ItemBought: AugmentedEvent<ApiType, [collection: u32, item: u32, price: u128, seller: AccountId20, buyer: AccountId20], { collection: u32, item: u32, price: u128, seller: AccountId20, buyer: AccountId20 }>;
      /**
       ...
       **/
      ItemPriceSet: AugmentedEvent<ApiType, [collection: u32, item: u32, price: u128, whitelistedBuyer: Option<AccountId20>], { collection: u32, item: u32, price: u128, whitelistedBuyer: Option<AccountId20> }>;
      /**
       ...
       * The owner changed.
       **/
      OwnerChanged: AugmentedEvent<ApiType, [collection: u32, newOwner: AccountId20], { collection: u32, newOwner: AccountId20 }>;
      /**
       * Ownership acceptance has changed for an account.
       **/
      OwnershipAcceptanceChanged: AugmentedEvent<ApiType, [who: AccountId20, maybeCollection: Option<u32>], { who: AccountId20, maybeCollection: Option<u32> }>;
      /**
       ...
       **/
      SwapClaimed: AugmentedEvent<ApiType, [sentCollection: u32, sentItem: u32, sentItemOwner: AccountId20, receivedCollection: u32, receivedItem: u32, receivedItemOwner: AccountId20, price: Option<PalletNftsPriceWithDirection>, deadline: u32], { sentCollection: u32, sentItem: u32, sentItemOwner: AccountId20, receivedCollection: u32, receivedItem: u32, receivedItemOwner: AccountId20, price: Option<PalletNftsPriceWithDirection>, deadline: u32 }>;
      /**
       ...
       **/
      TeamChanged: AugmentedEvent<ApiType, [collection: u32, issuer: Option<AccountId20>, admin: Option<AccountId20>, freezer: Option<AccountId20>], { collection: u32, issuer: Option<AccountId20>, admin: Option<AccountId20>, freezer: Option<AccountId20> }>;
      /**
       * A tip was sent.
       **/
      TipSent: AugmentedEvent<ApiType, [collection: u32, item: u32, sender: AccountId20, receiver: AccountId20, amount: u128], { collection: u32, item: u32, sender: AccountId20, receiver: AccountId20, amount: u128 }>;
      /**
       * An `item` of a `collection` has been approved by the `owner` for transfer by
       * a `delegate`.
       **/
      TransferApproved: AugmentedEvent<ApiType, [collection: u32, item: u32, owner: AccountId20, delegate: AccountId20, deadline: Option<u32>], { collection: u32, item: u32, owner: AccountId20, delegate: AccountId20, deadline: Option<u32> }>;
      /**
       * An `item` was transferred.
       **/
      Transferred: AugmentedEvent<ApiType, [collection: u32, item: u32, from: AccountId20, to: AccountId20], { collection: u32, item: u32, from: AccountId20, to: AccountId20 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    parameters: {
       ...
       **/
      Updated: AugmentedEvent<ApiType, [key: ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParametersKey, oldValue: Option<ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParametersValue>, newValue: Option<ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParametersValue>], { key: ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParametersKey, oldValue: Option<ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParametersValue>, newValue: Option<ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParametersValue> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    paymentStreams: {
       ...
       **/
      DynamicRatePaymentStreamCreated: AugmentedEvent<ApiType, [userAccount: AccountId20, providerId: H256, amountProvided: u64], { userAccount: AccountId20, providerId: H256, amountProvided: u64 }>;
      /**
       ...
       **/
      DynamicRatePaymentStreamDeleted: AugmentedEvent<ApiType, [userAccount: AccountId20, providerId: H256], { userAccount: AccountId20, providerId: H256 }>;
      /**
       ...
       **/
      DynamicRatePaymentStreamUpdated: AugmentedEvent<ApiType, [userAccount: AccountId20, providerId: H256, newAmountProvided: u64], { userAccount: AccountId20, providerId: H256, newAmountProvided: u64 }>;
      /**
       ...
       **/
      FixedRatePaymentStreamCreated: AugmentedEvent<ApiType, [userAccount: AccountId20, providerId: H256, rate: u128], { userAccount: AccountId20, providerId: H256, rate: u128 }>;
      /**
       * Event emitted when a fixed-rate payment stream is removed. Provides information about the User and Provider of the stream.
       **/
      FixedRatePaymentStreamDeleted: AugmentedEvent<ApiType, [userAccount: AccountId20, providerId: H256], { userAccount: AccountId20, providerId: H256 }>;
      /**
       ...
       **/
      FixedRatePaymentStreamUpdated: AugmentedEvent<ApiType, [userAccount: AccountId20, providerId: H256, newRate: u128], { userAccount: AccountId20, providerId: H256, newRate: u128 }>;
      /**
       ...
       **/
      InconsistentTickProcessing: AugmentedEvent<ApiType, [lastProcessedTick: u32, tickToProcess: u32], { lastProcessedTick: u32, tickToProcess: u32 }>;
      /**
       ...
       **/
      LastChargeableInfoUpdated: AugmentedEvent<ApiType, [providerId: H256, lastChargeableTick: u32, lastChargeablePriceIndex: u128], { providerId: H256, lastChargeableTick: u32, lastChargeablePriceIndex: u128 }>;
      /**
       ...
       **/
      PaymentStreamCharged: AugmentedEvent<ApiType, [userAccount: AccountId20, providerId: H256, amount: u128, lastTickCharged: u32, chargedAtTick: u32], { userAccount: AccountId20, providerId: H256, amount: u128, lastTickCharged: u32, chargedAtTick: u32 }>;
      /**
       ...
       **/
      UsersCharged: AugmentedEvent<ApiType, [userAccounts: Vec<AccountId20>, providerId: H256, chargedAtTick: u32], { userAccounts: Vec<AccountId20>, providerId: H256, chargedAtTick: u32 }>;
      /**
    ...
    proofsDealer: {
       ...
       **/
      MutationsApplied: AugmentedEvent<ApiType, [mutations: Vec<ITuple<[H256, ShpTraitsTrieMutation]>>, oldRoot: H256, newRoot: H256, eventInfo: Option<Bytes>], { mutations: Vec<ITuple<[H256, ShpTraitsTrieMutation]>>, oldRoot: H256, newRoot: H256, eventInfo: Option<Bytes> }>;
      /**
       * A set of mutations has been applied to the Forest of a given Provider.
       **/
      MutationsAppliedForProvider: AugmentedEvent<ApiType, [providerId: H256, mutations: Vec<ITuple<[H256, ShpTraitsTrieMutation]>>, oldRoot: H256, newRoot: H256], { providerId: H256, mutations: Vec<ITuple<[H256, ShpTraitsTrieMutation]>>, oldRoot: H256, newRoot: H256 }>;
      /**
       * A manual challenge was submitted.
       **/
      NewChallenge: AugmentedEvent<ApiType, [who: Option<AccountId20>, keyChallenged: H256], { who: Option<AccountId20>, keyChallenged: H256 }>;
      /**
       * A provider's challenge cycle was initialised.
       **/
      NewChallengeCycleInitialised: AugmentedEvent<ApiType, [currentTick: u32, nextChallengeDeadline: u32, provider: H256, maybeProviderAccount: Option<AccountId20>], { currentTick: u32, nextChallengeDeadline: u32, provider: H256, maybeProviderAccount: Option<AccountId20> }>;
      /**
       * A new challenge seed was generated.
       **/
      NewChallengeSeed: AugmentedEvent<ApiType, [challengesTicker: u32, seed: H256], { challengesTicker: u32, seed: H256 }>;
      /**
       * A new checkpoint challenge was generated.
       **/
      NewCheckpointChallenge: AugmentedEvent<ApiType, [challengesTicker: u32, challenges: Vec<PalletProofsDealerCustomChallenge>], { challengesTicker: u32, challenges: Vec<PalletProofsDealerCustomChallenge> }>;
      /**
       * A priority challenge was submitted.
       **/
      NewPriorityChallenge: AugmentedEvent<ApiType, [who: Option<AccountId20>, keyChallenged: H256, shouldRemoveKey: bool], { who: Option<AccountId20>, keyChallenged: H256, shouldRemoveKey: bool }>;
      /**
       ...
       **/
      ProofAccepted: AugmentedEvent<ApiType, [providerId: H256, proof: PalletProofsDealerProof, lastTickProven: u32], { providerId: H256, proof: PalletProofsDealerProof, lastTickProven: u32 }>;
      /**
       * A provider was marked as slashable and their challenge deadline was forcefully pushed.
       **/
      SlashableProvider: AugmentedEvent<ApiType, [provider: H256, nextChallengeDeadline: u32], { provider: H256, nextChallengeDeadline: u32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    providers: {
       ...
       **/
      AwaitingTopUp: AugmentedEvent<ApiType, [providerId: H256, topUpMetadata: PalletStorageProvidersTopUpMetadata], { providerId: H256, topUpMetadata: PalletStorageProvidersTopUpMetadata }>;
      /**
       ...
       **/
      BspRequestSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId20, multiaddresses: Vec<Bytes>, capacity: u64], { who: AccountId20, multiaddresses: Vec<Bytes>, capacity: u64 }>;
      /**
       * Event emitted when a Backup Storage Provider has signed off successfully. Provides information about
       * that BSP's account id.
       **/
      BspSignOffSuccess: AugmentedEvent<ApiType, [who: AccountId20, bspId: H256], { who: AccountId20, bspId: H256 }>;
      /**
       ...
       **/
      BspSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId20, bspId: H256, root: H256, multiaddresses: Vec<Bytes>, capacity: u64], { who: AccountId20, bspId: H256, root: H256, multiaddresses: Vec<Bytes>, capacity: u64 }>;
      /**
       * Event emitted when a bucket's root has been changed.
       **/
      BucketRootChanged: AugmentedEvent<ApiType, [bucketId: H256, oldRoot: H256, newRoot: H256], { bucketId: H256, oldRoot: H256, newRoot: H256 }>;
      /**
       ...
       **/
      BucketsOfInsolventMsp: AugmentedEvent<ApiType, [mspId: H256, buckets: Vec<H256>], { mspId: H256, buckets: Vec<H256> }>;
      /**
       ...
       **/
      CapacityChanged: AugmentedEvent<ApiType, [who: AccountId20, providerId: PalletStorageProvidersStorageProviderId, oldCapacity: u64, newCapacity: u64, nextBlockWhenChangeAllowed: u32], { who: AccountId20, providerId: PalletStorageProvidersStorageProviderId, oldCapacity: u64, newCapacity: u64, nextBlockWhenChangeAllowed: u32 }>;
      /**
       * Event emitted when the account ID of a provider that has just been marked as insolvent can't be found in storage.
       **/
      FailedToGetOwnerAccountOfInsolventProvider: AugmentedEvent<ApiType, [providerId: H256], { providerId: H256 }>;
      /**
       ...
       **/
      FailedToInsertProviderTopUpExpiration: AugmentedEvent<ApiType, [providerId: H256, expirationTick: u32], { providerId: H256, expirationTick: u32 }>;
      /**
       * Event emitted when there's an error slashing the now insolvent provider.
       **/
      FailedToSlashInsolventProvider: AugmentedEvent<ApiType, [providerId: H256, amountToSlash: u128, error: SpRuntimeDispatchError], { providerId: H256, amountToSlash: u128, error: SpRuntimeDispatchError }>;
      /**
       * Event emitted when there's an error stopping all cycles for an insolvent Backup Storage Provider.
       **/
      FailedToStopAllCyclesForInsolventBsp: AugmentedEvent<ApiType, [providerId: H256, error: SpRuntimeDispatchError], { providerId: H256, error: SpRuntimeDispatchError }>;
      /**
       ...
       **/
      MspRequestSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId20, multiaddresses: Vec<Bytes>, capacity: u64], { who: AccountId20, multiaddresses: Vec<Bytes>, capacity: u64 }>;
      /**
       * Event emitted when a Main Storage Provider has signed off successfully. Provides information about
       * that MSP's account id.
       **/
      MspSignOffSuccess: AugmentedEvent<ApiType, [who: AccountId20, mspId: H256], { who: AccountId20, mspId: H256 }>;
      /**
       ...
       **/
      MspSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId20, mspId: H256, multiaddresses: Vec<Bytes>, capacity: u64, valueProp: PalletStorageProvidersValuePropositionWithId], { who: AccountId20, mspId: H256, multiaddresses: Vec<Bytes>, capacity: u64, valueProp: PalletStorageProvidersValuePropositionWithId }>;
      /**
       * Event emitted when a Provider has added a new MultiAddress to its account.
       **/
      MultiAddressAdded: AugmentedEvent<ApiType, [providerId: H256, newMultiaddress: Bytes], { providerId: H256, newMultiaddress: Bytes }>;
      /**
       * Event emitted when a Provider has removed a MultiAddress from its account.
       **/
      MultiAddressRemoved: AugmentedEvent<ApiType, [providerId: H256, removedMultiaddress: Bytes], { providerId: H256, removedMultiaddress: Bytes }>;
      /**
       ...
       **/
      Slashed: AugmentedEvent<ApiType, [providerId: H256, amount: u128], { providerId: H256, amount: u128 }>;
      /**
       * Event emitted when an SP has topped up its deposit based on slash amount.
       **/
      TopUpFulfilled: AugmentedEvent<ApiType, [providerId: H256, amount: u128], { providerId: H256, amount: u128 }>;
      /**
       * Event emitted when an MSP adds a new value proposition.
       **/
      ValuePropAdded: AugmentedEvent<ApiType, [mspId: H256, valuePropId: H256, valueProp: PalletStorageProvidersValueProposition], { mspId: H256, valuePropId: H256, valueProp: PalletStorageProvidersValueProposition }>;
      /**
       * Event emitted when an MSP's value proposition is made unavailable.
       **/
      ValuePropUnavailable: AugmentedEvent<ApiType, [mspId: H256, valuePropId: H256], { mspId: H256, valuePropId: H256 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    randomness: {
       ...
       **/
      NewOneEpochAgoRandomnessAvailable: AugmentedEvent<ApiType, [randomnessSeed: H256, fromEpoch: u64, validUntilBlock: u32], { randomnessSeed: H256, fromEpoch: u64, validUntilBlock: u32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
