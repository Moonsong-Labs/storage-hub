...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    parameters: {
       ...
       * Stored parameters.
       **/
      parameters: AugmentedQuery<ApiType, (arg: ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParametersKey | { RuntimeConfig: any } | string | Uint8Array) => Observable<Option<ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParametersValue>>, [ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParametersKey]> & QueryableStorageEntry<ApiType, [ShSolochainEvmRuntimeConfigsRuntimeParamsRuntimeParametersKey]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    providers: {
       ...
       **/
      awaitingTopUpFromProviders: AugmentedQuery<ApiType, (arg: PalletStorageProvidersStorageProviderId | { BackupStorageProvider: any } | { MainStorageProvider: any } | string | Uint8Array) => Observable<Option<PalletStorageProvidersTopUpMetadata>>, [PalletStorageProvidersStorageProviderId]> & QueryableStorageEntry<ApiType, [PalletStorageProvidersStorageProviderId]>;
      /**
       ...
       **/
      insolventProviders: AugmentedQuery<ApiType, (arg: PalletStorageProvidersStorageProviderId | { BackupStorageProvider: any } | { MainStorageProvider: any } | string | Uint8Array) => Observable<Option<Null>>, [PalletStorageProvidersStorageProviderId]> & QueryableStorageEntry<ApiType, [PalletStorageProvidersStorageProviderId]>;
      /**
