...
declare module "@polkadot/types/types/registry" {
  interface InterfaceTypes {
    ...
    ShSolochainEvmRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxBspVolunteers: ShSolochainEvmRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxBspVolunteers;
    ShSolochainEvmRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxMspRespondFileKeys: ShSolochainEvmRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxMspRespondFileKeys;
