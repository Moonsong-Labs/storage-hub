...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    fileSystem: {
       ...
       **/
      AcceptedBspVolunteer: AugmentedEvent<ApiType, [bspId: H256, location: Bytes, fingerprint: H256, multiaddresses: Vec<Bytes>, owner: AccountId32, size_: u32], { bspId: H256, location: Bytes, fingerprint: H256, multiaddresses: Vec<Bytes>, owner: AccountId32, size_: u32 }>;
      /**
       * Notifies that a BSP confirmed storing a file.
       **/
      BspConfirmedStoring: AugmentedEvent<ApiType, [bspId: H256, location: Bytes], { bspId: H256, location: Bytes }>;
      /**
       * Notifies that a BSP has stopped storing a file.
       **/
      BspStoppedStoring: AugmentedEvent<ApiType, [bspId: H256, fileKey: H256, owner: AccountId32, location: Bytes], { bspId: H256, fileKey: H256, owner: AccountId32, location: Bytes }>;
      /**
       ...
       **/
      NewBucket: AugmentedEvent<ApiType, [who: AccountId32, mspId: H256, bucketId: H256, name: Bytes, collectionId: Option<u32>, private: bool], { who: AccountId32, mspId: H256, bucketId: H256, name: Bytes, collectionId: Option<u32>, private: bool }>;
      /**
       ...
       **/
      NewStorageRequest: AugmentedEvent<ApiType, [who: AccountId32, location: Bytes, fingerprint: H256, size_: u32, peerIds: Vec<Bytes>], { who: AccountId32, location: Bytes, fingerprint: H256, size_: u32, peerIds: Vec<Bytes> }>;
      /**
    ...
    paymentStreams: {
       ...
       **/
      DynamicRatePaymentStreamCreated: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256, amountProvided: u32], { userAccount: AccountId32, providerId: H256, amountProvided: u32 }>;
      /**
       ...
       **/
      DynamicRatePaymentStreamUpdated: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256, newAmountProvided: u32], { userAccount: AccountId32, providerId: H256, newAmountProvided: u32 }>;
      /**
       ...
       **/
      LastChargeableBlockUpdated: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256, lastChargeableBlock: u32], { userAccount: AccountId32, providerId: H256, lastChargeableBlock: u32 }>;
      /**
       ...
       **/
      PaymentStreamCharged: AugmentedEvent<ApiType, [userAccount: AccountId32, providerId: H256, amount: u128], { userAccount: AccountId32, providerId: H256, amount: u128 }>;
      /**
    ...
    proofsDealer: {
       ...
       **/
      NewChallenge: AugmentedEvent<ApiType, [who: AccountId32, keyChallenged: H256], { who: AccountId32, keyChallenged: H256 }>;
      /**
       * A proof was accepted.
       **/
      ProofAccepted: AugmentedEvent<ApiType, [provider: H256, proof: PalletProofsDealerProof], { provider: H256, proof: PalletProofsDealerProof }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    providers: {
       ...
       **/
      BspRequestSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u32], { who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u32 }>;
      /**
       ...
       **/
      BspSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u32], { who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u32 }>;
      /**
       ...
       **/
      CapacityChanged: AugmentedEvent<ApiType, [who: AccountId32, oldCapacity: u32, newCapacity: u32, nextBlockWhenChangeAllowed: u32], { who: AccountId32, oldCapacity: u32, newCapacity: u32, nextBlockWhenChangeAllowed: u32 }>;
      /**
       ...
       **/
      MspRequestSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u32, valueProp: PalletStorageProvidersValueProposition], { who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u32, valueProp: PalletStorageProvidersValueProposition }>;
      /**
       ...
       **/
      MspSignUpSuccess: AugmentedEvent<ApiType, [who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u32, valueProp: PalletStorageProvidersValueProposition], { who: AccountId32, multiaddresses: Vec<Bytes>, capacity: u32, valueProp: PalletStorageProvidersValueProposition }>;
      /**
