...
declare module "@polkadot/api-base/types/events" {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    crRandomness: {
       ...
       **/
      ProviderCycleInitialised: AugmentedEvent<
        ApiType,
        [providerId: H256, firstSeedCommitmentDeadlineTick: u32],
        { providerId: H256; firstSeedCommitmentDeadlineTick: u32 }
      >;
      /**
       * Event emitted when a Provider's CR cycle has been stopped. It has the information about the Provider ID.
       **/
      ProviderCycleStopped: AugmentedEvent<ApiType, [providerId: H256], { providerId: H256 }>;
      /**
       * Event emitted when a Provider submits their first seed commitment.
       **/
      ProviderInitialisedRandomness: AugmentedEvent<
        ApiType,
