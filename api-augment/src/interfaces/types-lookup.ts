...
declare module "@polkadot/types/lookup" {
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsRuntimeParametersValue (202) */
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigParametersValue (203) */
