...
declare module "@polkadot/types/lookup" {
  ...
  /** @name PalletRandomnessEvent (159) */
  ...
  /** @name PalletPaymentStreamsEvent (160) */
  ...
  /** @name PalletBucketNftsEvent (162) */
  ...
  /** @name PalletNftsAttributeNamespace (167) */
  ...
  /** @name PalletNftsPalletAttributes (171) */
  ...
  /** @name PalletParametersEvent (172) */
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsRuntimeParametersKey (173) */
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigParametersKey (174) */
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSlashAmountPerMaxFileSize (175) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSlashAmountPerMaxFileSize =
    Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigStakeToChallengePeriod (176) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigStakeToChallengePeriod = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigCheckpointChallengePeriod (177) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigCheckpointChallengePeriod =
    Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinChallengePeriod (178) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinChallengePeriod = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationLowerThresholdPercentage (179) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationLowerThresholdPercentage =
    Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationUpperThresholdPercentage (180) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigSystemUtilisationUpperThresholdPercentage =
    Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMostlyStablePrice (181) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMostlyStablePrice = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxPrice (182) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaxPrice = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinPrice (183) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinPrice = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigUpperExponentFactor (184) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigUpperExponentFactor = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigLowerExponentFactor (185) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigLowerExponentFactor = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigZeroSizeBucketFixedRate (186) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigZeroSizeBucketFixedRate =
    Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigIdealUtilisationRate (187) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigIdealUtilisationRate = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigDecayRate (188) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigDecayRate = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinimumTreasuryCut (189) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMinimumTreasuryCut = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaximumTreasuryCut (190) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigMaximumTreasuryCut = Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigBspStopStoringFilePenalty (191) */
  type StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigBspStopStoringFilePenalty =
    Null;

  /** @name StorageHubRuntimeConfigsRuntimeParamsRuntimeParametersValue (193) */
  ...
  /** @name StorageHubRuntimeConfigsRuntimeParamsDynamicParamsRuntimeConfigParametersValue (194) */
  ...
  /** @name FrameSystemLastRuntimeUpgradeInfo (199) */
  interface FrameSystemLastRuntimeUpgradeInfo extends Struct {
    readonly specVersion: Compact<u32>;
    readonly specName: Text;
  }

  /** @name FrameSystemCodeUpgradeAuthorization (201) */
  interface FrameSystemCodeUpgradeAuthorization extends Struct {
    readonly codeHash: H256;
    readonly checkVersion: bool;
  }

  /** @name FrameSystemCall (202) */
  ...
  /** @name FrameSystemLimitsBlockWeights (205) */
  ...
  /** @name FrameSupportDispatchPerDispatchClassWeightsPerClass (206) */
  ...
  /** @name FrameSystemLimitsWeightsPerClass (207) */
  ...
  /** @name FrameSystemLimitsBlockLength (209) */
  interface FrameSystemLimitsBlockLength extends Struct {
    readonly max: FrameSupportDispatchPerDispatchClassU32;
  }

  /** @name FrameSupportDispatchPerDispatchClassU32 (210) */
  ...
  /** @name SpWeightsRuntimeDbWeight (211) */
  interface SpWeightsRuntimeDbWeight extends Struct {
    readonly read: u64;
    readonly write: u64;
  }

  /** @name SpVersionRuntimeVersion (212) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentAncestor (219) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentUsedBandwidth (220) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentHrmpChannelUpdate (222) */
  interface CumulusPalletParachainSystemUnincludedSegmentHrmpChannelUpdate extends Struct {
    readonly msgCount: u32;
    readonly totalBytes: u32;
  }

  /** @name PolkadotPrimitivesV8UpgradeGoAhead (226) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentSegmentTracker (227) */
  ...
  /** @name PolkadotPrimitivesV8PersistedValidationData (228) */
  ...
  /** @name PolkadotPrimitivesV8UpgradeRestriction (231) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot (234) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotRelayDispatchQueueRemainingCapacity (235) */
  ...
  /** @name PolkadotPrimitivesV8AbridgedHrmpChannel (238) */
  ...
  /** @name PolkadotPrimitivesV8AbridgedHostConfiguration (239) */
  ...
  /** @name PolkadotPrimitivesV8AsyncBackingAsyncBackingParams (240) */
  interface PolkadotPrimitivesV8AsyncBackingAsyncBackingParams extends Struct {
    readonly maxCandidateDepth: u32;
    readonly allowedAncestryLen: u32;
  }

  /** @name PolkadotCorePrimitivesOutboundHrmpMessage (246) */
  interface PolkadotCorePrimitivesOutboundHrmpMessage extends Struct {
    readonly recipient: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemCall (248) */
  ...
  /** @name CumulusPrimitivesParachainInherentParachainInherentData (249) */
  ...
  /** @name PolkadotCorePrimitivesInboundDownwardMessage (251) */
  interface PolkadotCorePrimitivesInboundDownwardMessage extends Struct {
    readonly sentAt: u32;
    readonly msg: Bytes;
  }

  /** @name PolkadotCorePrimitivesInboundHrmpMessage (254) */
  interface PolkadotCorePrimitivesInboundHrmpMessage extends Struct {
    readonly sentAt: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemError (257) */
  ...
  /** @name StagingParachainInfoCall (259) */
  type StagingParachainInfoCall = Null;

  /** @name PalletBalancesBalanceLock (261) */
  ...
  /** @name PalletBalancesReasons (262) */
  ...
  /** @name PalletBalancesReserveData (265) */
  interface PalletBalancesReserveData extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name StorageHubRuntimeRuntimeHoldReason (269) */
  ...
  /** @name PalletStorageProvidersHoldReason (270) */
  ...
  /** @name PalletFileSystemHoldReason (271) */
  ...
  /** @name PalletPaymentStreamsHoldReason (272) */
  ...
  /** @name FrameSupportTokensMiscIdAmount (275) */
  ...
  /** @name PalletBalancesAdjustmentDirection (280) */
  ...
  /** @name StorageHubRuntimeSessionKeys (287) */
  ...
  /** @name StagingXcmExecutorAssetTransferTransferType (328) */
  ...
  /** @name PalletStorageProvidersCall (332) */
  ...
  /** @name PalletFileSystemBucketMoveRequestResponse (334) */
  ...
  /** @name PalletFileSystemStorageRequestMspBucketResponse (336) */
  ...
  /** @name PalletFileSystemStorageRequestMspAcceptedFileKeys (338) */
  ...
  /** @name PalletFileSystemFileKeyWithProof (340) */
  interface PalletFileSystemFileKeyWithProof extends Struct {
    readonly fileKey: H256;
    readonly proof: ShpFileKeyVerifierFileKeyProof;
  }

  /** @name PalletFileSystemRejectedStorageRequest (343) */
