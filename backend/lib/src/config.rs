...
use crate::constants::{
    ...
    rpc::{
        ...
        DEFAULT_MSP_INTERNAL_FILE_TRANSFER_URL, DEFAULT_RPC_URL, DEFAULT_TIMEOUT_SECS,
...
pub struct MspConfig {
    ...
    /// URL for the MSP internal file transfer server
    pub internal_file_transfer_url: String,
    ...
    fn default() -> Self {
        Self {
            ...
            msp: MspConfig {
                ...
                internal_file_transfer_url: DEFAULT_MSP_INTERNAL_FILE_TRANSFER_URL.to_string(),
