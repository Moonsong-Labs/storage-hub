...
for (const bspNetConfig of bspNetConfigCases) {
    describe("User: File Upload", () => {
        ...
        it("issueStorageRequest fails if bucket does not exist", async () => {
            ...
            // random 32 bytes
            let bucketId = "1ce1a1614e9798e9c7f2b7214ca73c87";
        ...
        it("loadFileInStorage for inexistent file fails", async () => {
            ...
            try {
                ...
                strictEqual(e.message, "-32603: Internal error: Os { code: 2, kind: NotFound, message: \"No such file or directory\" }");
            }
        });
    });
}