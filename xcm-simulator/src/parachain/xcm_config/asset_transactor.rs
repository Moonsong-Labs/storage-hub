...
use crate::parachain::{
    constants::DotLocation, location_converter::LocationConverter, AccountId, Balances,
    ForeignUniques,
};
...
type LocalAssetTransactor = (
    FungibleAdapter<Balances, IsConcrete<DotLocation>, LocationConverter, AccountId, ()>,
    NonFungiblesAdapter<
        ForeignUniques,
