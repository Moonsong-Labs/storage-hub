        ...
        + 'static
{
    ...
    /// The runtime's error enum, generated by `#[runtime::derive(RuntimeError)]`.
    /// This type represents the already-decoded error variants from all pallets in the runtime.
    ///
