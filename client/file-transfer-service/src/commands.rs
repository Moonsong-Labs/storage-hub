...
#[actor_command(
    service = FileTransferService<Runtime: StorageEnableRuntimeConfig>,
    default_mode = "ImmediateResponse",
    default_error_type = RequestError
)]
pub enum FileTransferServiceCommand<Runtime: shc_common::traits::StorageEnableRuntimeConfig> {
    #[command(
        mode = "AsyncResponse", 
...
#[async_trait]
impl<Runtime: StorageEnableRuntimeConfig> FileTransferServiceCommandInterfaceExt
